...
# ---------------------------------------------------------
# PAGE CONFIGURATION
# NOTE: st.set_page_config() can only be called ONCE, and it
# must be the very first Streamlit command in the script.
# (Previously this was being called twice, which crashes the app.)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# THEME (logo + CSS now live in modules/branding.py)
# ---------------------------------------------------------
